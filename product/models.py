...
class Product(models.Model):
    ...
    isrecurring = models.CharField(max_length=1, choices=YES_NO_CHOICES, default='N')
    ...
    is_stock_required = models.BooleanField(max_length=1, choices=YES_NO_CHOICES, default='N')
